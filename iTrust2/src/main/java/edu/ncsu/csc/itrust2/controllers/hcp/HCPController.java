...
public class HCPController {
     ...
     */
    @GetMapping ( "/hcp/uploadPatients" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String uploadPatients ( final Model model ) {
        return "/hcp/uploadPatients";
    }
     ...
     * @return The page the patient to enter entries.
     */
    @GetMapping ( "/hcp/trackingContacts" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String trackingContacts ( final Model model ) {
        return "/hcp/trackingContacts";
    }
     ...
     * @return The page to display to the patient.
     */
    @GetMapping ( "/hcp/PlotPassengerStatistic" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String plotPassengerStatistic () {
        return "/hcp/PlotPassengerStatistic";
    }
     ...
     * @return The page to display to the patient.
     */
    @GetMapping ( "/hcp/calculatedR0" )
    @PreAuthorize ( "hasAnyRole('ROLE_HCP', 'ROLE_OD', 'ROLE_OPH')" )
    public String calculatedR0 ( final Model model ) {
        return "/hcp/calculatedR0";
    }
}
