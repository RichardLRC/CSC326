...
public enum TransactionType {
    ...
    /**
     * HCP Upload Passenger Lists
     */
    UPLOAD_PASSENGER_LIST ( 2700, "HCP upload a passenger list.", true ),

    /**
     * HCP views severity code
     */
    VIEW_SEVERITY_CODE ( 2800, "HCP views number of the severity code.", true ),

    /**
     * HCP views infected patients per day
     */
    VIEW_INFECTED_PER_DAY ( 2801, "HCP views number of infected patients per day", true ),

    /**
     * HCP gets the reproductive number
     */
    CALCULATE_R0 ( 2900, "HCP gets the reproductive number", true );
